...
class Tp_Product_Description_In_Loop_For_Woocommerce {
	...
	private function define_public_hooks() {
		...
		if ('Astra' === $current_theme->get('Name')) {
			
			if($description_position == 'woocommerce_shop_loop_item_title' && $description_priority == 5) {
				//woocommerce_shop_loop_item_title 5 -> Befor Title 
				//astra_woo_shop_title_before
				$description_position = 'astra_woo_shop_title_before';
			}
			elseif($description_position == 'woocommerce_after_shop_loop_item_title' && $description_priority == 10) {
				//woocommerce_after_shop_loop_item_title 10 -> After Title
				//astra_woo_shop_title_after
				$description_position = 'astra_woo_shop_title_after';
			}
			elseif($description_position == 'woocommerce_after_shop_loop_item_title' && $description_priority == 20) {
				//woocommerce_after_shop_loop_item_title 20 -> After Price
				//astra_woo_shop_price_after
				$description_position = 'astra_woo_shop_price_after';
			}
			else {
				//woocommerce_after_shop_loop_item 15 -> After "Add to cart" Button
				//astra_woo_shop_add_to_cart_after
				$description_position = 'astra_woo_shop_add_to_cart_after';
			}
