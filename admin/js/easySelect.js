  ...
  $.fn.easySelect = function (options) {
    return this.each(function () {
      ...
      for (var i = 0; i < numberOfOptions; i++) {
        ...
        var $label = $("<label/> ", {
          class: "easySelectcontainer-item",
      ...
      $styledSelect.click(function (e) {
        ...
        $("div.styledSelect.active").each(function () {
          $(this).removeClass("active").next("ul.tpesoptions").hide();
        });
        $(this).toggleClass("active").next("ul.tpesoptions").toggle();
      });
      ...
      $input.on("keyuo", function () {
        var val = $(this).val();
        var isMatch = false;
        $listItems.find(".easySelectcontainer-item").each(function (i) {
